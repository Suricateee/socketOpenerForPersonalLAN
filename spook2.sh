amixer -D pulse set Master 50% unmute && timeout 20 ffplay -nodisp -nostats -hide_banner -autoexit https://www.myinstants.com/media/sounds/daisy-bell-creepy-version.mp3 &
for run in {1..8};do
sleep $(shuf -i 0-3 -n 1)
notify-send "Man in the dark" "I see you"
